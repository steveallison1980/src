...
const CAREERSMETADESC = "Careers at Ohtsuka: We're looking for patent attorneys and engineers and translation/communication staff";
const CAREERSMETADESCJP = "採用情報：弁理士・特許技術者、事務管理部門、図面トレーサー";
