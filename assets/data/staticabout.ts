...
// TODO: add Japanese description of about us page
...
export const KEYFEATURES: Array<string> = [
    "1. The Right Experts",
...
export const KEYFEATURESJP: Array<string> = [
    "1．豊富な専門家集団",
...
// access page
export const ACCESSTITLE = "Access"

export const ACCESSTITLEJP = "アクセス"

export const ACCESS: Array<string> = [
    "Location and Contact Information",
    "OHTSUKA PATENT OFFICE",
    "7TH FL., KIOICHO PARK BLDG.,",
    "3-6, KIOICHO, CHIYODA-KU,",
    "TOKYO 102-0094, JAPAN",
    "TEL：+81-3-5276-3241／FAX: +81-3-5276-3242",
    "E-mail：opt@patest.co.jp",
    "Map"
];

export const ACCESSJP: Array<string> = [
    "所在地・連絡先",
    "〒102-0094",
    "東京都千代田区紀尾井町3-6紀尾井町パークビル7F",
    "TEL：03-5276-3241／FAX: 03-5276-3242",
    "E-mail：opt@patest.co.jp",
    "地図"
];