...
export const ABOUTTITLEJP = "事務所紹介とご挨拶"
...
export const RIGHTJP: Array<string> = [
    ...
    "また、多くの弁理士は企業・大学での研究者、知財担当者としての経験を備え、数名の弁理士は通信、自動車、化学分野での特許庁の審査官・審判官経験を持ちます。これらの経験を活かしてその案件をリアルな感覚で把握し、お客様の満足のいくゴールを目指し仕事に取り組んでいます。"
];
...
export const LITIGATIONJP: Array<string> = [
    "特許訴訟の本質は、特許された発明（技術）と生の技術との間の類非の争いです。数多くの特許取得で蓄積した経験、技術への深い理解は、特許訴訟で必要とされる重要なスキルです。当事務所は特許侵害訴訟、特許無効審判、税関手続きなどに、特許の有効論、侵害論など特許技術の面から参画し、ご満足いただける多くの結果を出しています。",
...
export const DEVELOPJP: Array<string> = [
    "特許の出願一つをとっても、出願に続く審査、場合によっては審判にも対応し、長期に渡りお客様をダイナミックにサポートしなければなりません。高い信頼性と発展可能性を維持し、最適なサービスを継続的に提供していくためには、新たな人材の育成が必須です。そこで、当事務所では、大学（日本、欧米）/ 企業で研究や開発に携わった人材を迎え、有能な弁理士・特許技術者を育成してきました。これらの人材に、企業の知財経験者、特許庁の審査官・審判官経験者が加わり、経験・バックグラウンド・視点の多様性を広げ、活力あるチームを編成しています。",
...
export const SUPPORTJP: Array<string> = [
    "仕事の工程・期限の正確な管理、コスト管理、データベース管理を事務・管理部門の重要な仕事と位置づけています。手続きが世界の多くの国々に跨り、国ごとに特徴のある手続き、期限、ドキュメンテ-ションが必要な特許・商標の世界では、事務部門の知識と経験はスムーズに手続きを行うために極めて重要です。国内外での出願、裁判、審判手続きなどに豊富な経験を持つ有能なパラリーガルがデータベースの設定やアップデートを行い、案件の進捗を管理し、お客様への迅速で的確なサービスに努めています。"
];
