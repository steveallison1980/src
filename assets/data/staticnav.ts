    ...
    pages: [
        ...
        },
        {
            ...
            links: [
                ...
                { text: 'Table of Contents', textJP: '目次', icon: 'view_list', subPage: TOCGUIDANCEPAGEKEY, curPage: GUIDANCEPAGEKEY, routerlink: '/guidancetoc', displayMode: 'both', bShowInMenu: false }
            ],
            displayMode: "ENonly",
        }
    ]
