...
export const SITEMAP_DATA: ISitemap =
{
    pages: [
        ...
        },
        {
            ...
            links: [
                { text: '', textJP: 'CAFC判決', icon: 'menu_book', subPage: 'all', curPage: 'cafcreports' },
                { text: '', textJP: '2019年', icon: 'menu_book', subPage: '2019', curPage: 'cafcreports' },
                { text: '', textJP: '2018年', icon: 'menu_book', subPage: '2018', curPage: 'cafcreports' },
                { text: '', textJP: '2017年', icon: 'menu_book', subPage: '2017', curPage: 'cafcreports' },
                { text: '', textJP: '2016年', icon: 'menu_book', subPage: '2016', curPage: 'cafcreports' },
                { text: '', textJP: '2015年', icon: 'menu_book', subPage: '2015', curPage: 'cafcreports' },
                { text: '', textJP: '2014年', icon: 'menu_book', subPage: '2014', curPage: 'cafcreports' },
                { text: '', textJP: '2013年', icon: 'menu_book', subPage: '2013', curPage: 'cafcreports' },
                { text: '', textJP: '2012年', icon: 'menu_book', subPage: '2012', curPage: 'cafcreports' },
                { text: '', textJP: '2011年', icon: 'menu_book', subPage: '2011', curPage: 'cafcreports' },
                { text: '', textJP: '2010年', icon: 'menu_book', subPage: '2010', curPage: 'cafcreports' },
                { text: '', textJP: '2009年', icon: 'menu_book', subPage: '2009', curPage: 'cafcreports' },
                { text: '', textJP: '2008年', icon: 'menu_book', subPage: '2008', curPage: 'cafcreports' },
                { text: '', textJP: '2007年', icon: 'menu_book', subPage: '2007', curPage: 'cafcreports' },
                { text: '', textJP: '2006年', icon: 'menu_book', subPage: '2006', curPage: 'cafcreports' },
                { text: '', textJP: '2005年', icon: 'menu_book', subPage: '2005', curPage: 'cafcreports' },
            ], 
            displayMode: "JPonly",
        },
        {
