    ...
    pages: [
        ...
        },
        {
            ...
            links: [
                ...
                { text: '', textJP: 'ご案内', icon: 'help', subPage: 'setsumeikaiguidepage', curPage: 'careers', routerlink: '/setsumeikaiguidepage', displayMode: 'JPonly' },
        ...
        },
        {
            ...
            links: [
                { text: 'CAFC Reports (all)', textJP: 'CAFC判決(全件）', icon: 'menu_book', subPage: 'cafcall', curPage: 'cafcreports', routerlink: '/cafcall', displayMode: 'both' },
                { text: '2019', textJP: '2019年', icon: 'menu_book', subPage: 'cafc2019', curPage: 'cafcreports', routerlink: '/cafc2019', displayMode: 'both' },
                { text: '2018', textJP: '2018年', icon: 'menu_book', subPage: 'cafc2018', curPage: 'cafcreports', routerlink: '/cafc2018', displayMode: 'both' },
                { text: '2017', textJP: '2017年', icon: 'menu_book', subPage: 'cafc2017', curPage: 'cafcreports', routerlink: '/cafc2017', displayMode: 'both' },
                { text: '2016', textJP: '2016年', icon: 'menu_book', subPage: 'cafc2016', curPage: 'cafcreports', routerlink: '/cafc2016', displayMode: 'both' },
                { text: '2015', textJP: '2015年', icon: 'menu_book', subPage: 'cafc2015', curPage: 'cafcreports', routerlink: '/cafc2015', displayMode: 'both' },
                { text: '2014', textJP: '2014年', icon: 'menu_book', subPage: 'cafc2014', curPage: 'cafcreports', routerlink: '/cafc2014', displayMode: 'both' },
                { text: '2013', textJP: '2013年', icon: 'menu_book', subPage: 'cafc2013', curPage: 'cafcreports', routerlink: '/cafc2013', displayMode: 'both' },
                { text: '2012', textJP: '2012年', icon: 'menu_book', subPage: 'cafc2012', curPage: 'cafcreports', routerlink: '/cafc2012', displayMode: 'both' },
                { text: '2011', textJP: '2011年', icon: 'menu_book', subPage: 'cafc2011', curPage: 'cafcreports', routerlink: '/cafc2011', displayMode: 'both' },
                { text: '2010', textJP: '2010年', icon: 'menu_book', subPage: 'cafc2010', curPage: 'cafcreports', routerlink: '/cafc2010', displayMode: 'both' },
                { text: '2009', textJP: '2009年', icon: 'menu_book', subPage: 'cafc2009', curPage: 'cafcreports', routerlink: '/cafc2009', displayMode: 'both' },
                { text: '2008', textJP: '2008年', icon: 'menu_book', subPage: 'cafc2008', curPage: 'cafcreports', routerlink: '/cafc2008', displayMode: 'both' },
                { text: '2007', textJP: '2007年', icon: 'menu_book', subPage: 'cafc2007', curPage: 'cafcreports', routerlink: '/cafc2007', displayMode: 'both' },
                { text: '2006', textJP: '2006年', icon: 'menu_book', subPage: 'cafc2006', curPage: 'cafcreports', routerlink: '/cafc2006', displayMode: 'both' },
                { text: '2005', textJP: '2005年', icon: 'menu_book', subPage: 'cafc2005', curPage: 'cafcreports', routerlink: '/cafc2005', displayMode: 'both' },
            ], 
            displayMode: "JPonly",
        },
        {
            ...
            links: [
                { text: 'Patents', textJP: '特許', icon: 'lightbulb', subPage: 'patent', curPage: 'guidance', routerlink: '/guidance/patent', displayMode: 'both' },
                { text: 'Trademarks', textJP: '商標', icon: 'beach_access', subPage: 'trademark', curPage: 'guidance', routerlink: '/guidance/trademark', displayMode: 'both' },
                { text: 'Designs', textJP: '意匠', icon: 'category', subPage: 'design', curPage: 'guidance', routerlink: '/guidance/design', displayMode: 'both' }
            ],
            displayMode: "ENonly",
        }
    ]
