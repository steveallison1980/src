...
export const SITEMAP_DATA: ISitemap =
{
    pages: [
        ...
        },
        {
            ...
            links: [
                { text: '', textJP: 'CAFC判決', icon: 'menu_book', subPage: 'cafcreports', curPage: 'all' },
                { text: '', textJP: '2019年', icon: 'menu_book', subPage: '2019', curPage: '2019年' },
                { text: '', textJP: '2018年', icon: 'menu_book', subPage: '2018', curPage: '2018年' },
                { text: '', textJP: '2017年', icon: 'menu_book', subPage: '2017', curPage: '2017年' },
                { text: '', textJP: '2016年', icon: 'menu_book', subPage: '2016', curPage: '2016年' },
                { text: '', textJP: '2015年', icon: 'menu_book', subPage: '2015', curPage: '2015年' },
                { text: '', textJP: '2014年', icon: 'menu_book', subPage: '2014', curPage: '2014年' },
                { text: '', textJP: '2013年', icon: 'menu_book', subPage: '2013', curPage: '2013年' },
                { text: '', textJP: '2012年', icon: 'menu_book', subPage: '2012', curPage: '2012年' },
                { text: '', textJP: '2011年', icon: 'menu_book', subPage: '2011', curPage: '2011年' },
                { text: '', textJP: '2010年', icon: 'menu_book', subPage: '2010', curPage: '2010年' },
                { text: '', textJP: '2009年', icon: 'menu_book', subPage: '2009', curPage: '2009年' },
                { text: '', textJP: '2008年', icon: 'menu_book', subPage: '2008', curPage: '2008年' },
                { text: '', textJP: '2007年', icon: 'menu_book', subPage: '2007', curPage: '2007年' },
                { text: '', textJP: '2006年', icon: 'menu_book', subPage: '2006', curPage: '2006年' },
                { text: '', textJP: '2005年', icon: 'menu_book', subPage: '2005', curPage: '2005年' },
            ], 
            displayMode: "JPonly",
        },
        {
