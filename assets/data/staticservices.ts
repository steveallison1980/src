...
export const CAFCDECJP: Array<string> = [
    "判例が法律となるアメリカで2016年に提起された特許訴訟の件数は4500件に及び、日本の9倍以上の数です。連邦裁判所からの控訴事件はCAFCで審理されるため、CAFCは世界最大の特許事件を取り扱う国家機関と言えます。また、頂点に位置する米国最高裁判所もタイムリーに重要な判決を出しています。特許の侵害判断、有効性の判断は、特許と対象製品に共通性があれば、裁判国が違ってもそれぞれの国の裁判所の判断は同様な結論になる傾向があります。従って、日本と比べ遥かに判決の多い米国の判例を勉強し、判例の変化、事件解決のロジックを学び、日々の仕事に活かすことは重要です。",
...
export const JAPANDECJP: Array<string> = [
    ...
    "我々も訴訟分野での仕事は、ＩｏＴの時代おいて極めて大きな影響力を持つ判決を獲得した他、有力な判決の活用により幾つかの成果を上げています。",
