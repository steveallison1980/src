...
export const CAFCDECTITLE = "Reports of CAFC Decisions"
...
export const CAFCDECJP: Array<string> = [
    ...
    "この一環として、Milbank, Tweed, Hadley & McCloy事務所と当事務所は、1999年から現在まで18年以上に亘って、米国のCAFC(連邦控訴裁判所)を中心とする知的財産関連の判例を勉強すると共に、月刊誌The Lawyersで毎月、日本の購読者に紹介しています。 紹介した判決数は700件以上になります。"
];
